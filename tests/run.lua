...
assert(pin_lines[1] == '1 core.lua', 'pin rows should be compact, got: ' .. pin_lines[1])
local pin_ns = vim.api.nvim_get_namespaces()['MiniharpUI']
local hls = vim.api.nvim_buf_get_extmarks(pin_buf, pin_ns, 0, -1, {})
assert(#hls == 1 and hls[1][2] == 0, 'pin should highlight the current file row')
